        ...
        if (check) {
            ...
            if (addons_info.get(0) == 0) {
                ...
                switch (addons_id) {
                    ...
                    case 8 -> old_check_delivery_attachment_capacity = addonsAddRemoveCheck.check_delivery_attachment_capacity();
                }
                ...
                switch (addons_id) {
                    ...
                    case 8 -> {
                        ...
                        soft.assertNotEquals(current_check_delivery_attachment_capacity, old_check_delivery_attachment_capacity,
                                "[" + addons_name.get(addons_id) + "]" + "[Failed] Maximum delivery attachment capacity is not increased from 2MB to 10MB.");
                    }
                }
            }
        }
