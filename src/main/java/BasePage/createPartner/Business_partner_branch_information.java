...
public class Business_partner_branch_information {
    ...
    public void branch_address(WebDriver driver) {
        // Address
    ...
    public void switch_to_transaction_terms(WebDriver driver) {
