...
public class Business_partner_information {
    ...
    public void customer_name(WebDriver driver) {
        // Customer name
    ...
    public void customer_evaluation(WebDriver driver) {
        // Customer evaluation
    ...
    public void country_of_citizenship(WebDriver driver) {
    ...
    public void fiscal_year(WebDriver driver) {
        Actions key = new Actions(driver);
        // Fiscal year
    ...
    public void number_of_employees(WebDriver driver) {
        // Number of employees
    ...
    public void contract(WebDriver driver) {
        //Contract
        // 1: None, 2: Can be
