...
public class Transaction_terms {
    public void number_of_years_required_for_transactions(WebDriver driver, String role, Common cm) {
    ...
    public void capital_required_for_transactions(WebDriver driver, String role, Common cm) {
        // Master, Administrator, Responsible person, Leader, Member
        if (cm.authorized(role, cm.role_list(5))) {
    ...
    public void qualifications_required_for_transactions(WebDriver driver, String role, Common cm) {
        // Master, Administrator, Responsible person, Leader, Member
        if (cm.authorized(role, cm.role_list(5))) {
    ...
    public void finish_register_partner(WebDriver driver, String role, Common cm) {
        // Master, Administrator, Responsible person, Leader, Member
        if (cm.authorized(role, cm.role_list(5))) {
            // Click 登 録 button
