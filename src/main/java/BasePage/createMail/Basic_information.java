...
public class Basic_information {
    public void format(WebDriver driver) throws InterruptedException {
        // Format
        // 1: Text, 2: Html
    ...
    public void distributor(WebDriver driver, Actions key) throws InterruptedException {
        // Distributor
    ...
    public void subject(WebDriver driver) {
    ...
    public void insertion(WebDriver driver) {
    ...
    public void send_a_copy_to_the_distributor(WebDriver driver) {
    ...
    public void next_to_attachment_step(WebDriver driver) {
        // Next to 添付ファイル_Step
