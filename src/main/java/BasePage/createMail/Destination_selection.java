...
public class Destination_selection {
    ...
    public Destination_selection(WebDriver driver, Actions key, String role, Common cm, String url_mail_list, String partnerPIC_url) {
        this.driver = driver;
        this.key = key;
        this.role = role;
        this.cm = cm;
    ...
    public void next_to_final_confirmation() {
        ...
        if (cm.authorized(role, cm.role_list(5))) {
            ...
            // Check current tab
            boolean check = driver.findElement(By.cssSelector("div:nth-child(4)>div>div.ant-steps-item-icon")).isEnabled();
            Assert.assertTrue(check, "[Failed] Can not next to Final confirmation from Destination selection.");
        }
    }
