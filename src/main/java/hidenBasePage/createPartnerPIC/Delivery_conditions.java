...
public class Delivery_conditions {
    ...
    public void proposal_delivery(WebDriver driver, String role, Common cm) {
        ...
        if (cm.authorized(role, cm.role_list(5))) {
            ...
            if (proposal_delivery == 1) {
                ...
                for (int i = 1; i <= development_job_description_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='jobtype_dev']")).click();
                }
                ...
                for (int i = 1; i <= development_job_skill_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='jobskill_dev']")).click();
                }
                ...
                for (int i = 1; i <= infrastructure_job_description_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='jobtype_infra']")).click();
                }
                ...
                for (int i = 1; i <= infrastructure_skill_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + " )>span>input[id^='jobskill_infra']")).click();
                }
                ...
                for (int i = 1; i <= others_job_description_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='jobtype_other']")).click();
                }
                ...
                driver.findElement(By.cssSelector("#job_syouryu>label:nth-child(" + commercial_distribution + ")>span:nth-child(1)>input")).click();
            }
        }
    }

    public void personnel_delivery(WebDriver driver, String role, Common cm) {
        // Master, Administrator, Responsible person, Leader, Member
        if (cm.authorized(role, cm.role_list(5))) {
            // Personnel delivery
            // 0: OFF, 1: ON
            ...
            if (personnel_delivery == 1) {
                ...
                // select job description details from 1 to development_job_description_details
                for (int i = 1; i <= development_job_description_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='personneltype_dev']")).click();
                }
                // Development: Skill details
                // 1:Requirement definition, 2:Basic design, 3:Detailed design, 4:Manufacturing, 5:Testing/verification, 6:Maintenance and operation, 7:Inexperienced
                int development_job_skill_details = RandomUtils.nextInt(7) + 1;
                // select skill details from 1 to development_job_skill_details
                for (int i = 1; i <= development_job_skill_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='personnelskill_dev']")).click();
                }
                ...
                //select job description details from 1 to infrastructure_delivery_occupation
                for (int i = 1; i <= infrastructure_job_description_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='personneltype_infra']")).click();
                }
                // Infrastructure: Skill details
                // 1:Requirement definition, 2:Basic design, 3:Detailed design, 4:Manufacturing, 5:Testing/verification, 6:Maintenance and operation, 7:Surveillance, 8:Inexperienced
                int infrastructure_skill_details = RandomUtils.nextInt(8) + 1;
                // select skill details from 1 to infrastructure_skill_details
                for (int i = 1; i <= infrastructure_skill_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + " )>span>input[id^='personnelskill_infra']")).click();
                }
                ...
                // select job description details from 1 to others_job_description_details
                for (int i = 1; i <= others_job_description_details; i++) {
                    driver.findElement(By.cssSelector("label.ContactForm-horizontalCheckboxStyle-1I13p:nth-child(" + i + ")>span>input[id^='personneltype_other']")).click();
                }
                ...
                for (int i = 1; i <= delivery_employment_form; i++) {
                    driver.findElement(By.cssSelector("label:nth-child(" + i + ")>span>input[id^='job_koyou']")).click();
                }

                // Commercial distribution restrictions
                // 1:None , 2:To the end direct / main contract direct, 3:Until the first contract, 4:Until the second contract
                int commercial_distribution = RandomUtils.nextInt(4) + 1;
                driver.findElement(By.cssSelector("#personnel_syouryu>label:nth-child(" + commercial_distribution + ")>span:nth-child(1)>input")).click();
            }
        }
    }

    public void desired_area(WebDriver driver, String role, Common cm) {
        // Master, Administrator, Responsible person, Leader, Member
        if (cm.authorized(role, cm.role_list(5))) {
    ...
    public void complete_create_partner_pic(WebDriver driver, String role, Common cm) {
        // Master, Administrator, Responsible person, Leader, Member
        if (cm.authorized(role, cm.role_list(5))) {
