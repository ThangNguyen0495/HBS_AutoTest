...
public class Delivered_Mail_Edit {
    ...
    @BeforeMethod
    @Parameters({"headless", "email", "password", "domain", "mail_id", "role", "capacity"})
    public void init(Boolean headless, String email, String password, String domain, String mail_id, String role, int capacity) throws InterruptedException {
        ...
        //Login
        cm.login(driver, domain + mail_list_path + "/" + mail_id, email, password);

        // Init Basic information function
        bi = new Step1_Basic_Information(driver, role, cm, domain, "Edit");

        // Init Attachment function
        a = new Step2_Attachment(driver, role, cm, domain, capacity, "Edit");

        // Init Destination selection function
        ds = new Step3_Destination_selection(driver, cm, role, domain, "Edit");

        // Init Final confirmation function
        fc = new Step4_Final_confirmation(driver, role, cm, domain, "Edit");
    }
...
//        ds.commitment();
    ...
    public void TC_11_do_you_want_to_delete_this_delivered_email_Cancel_basic_information() throws InterruptedException {
        ...
        bi.switch_url_before_run_test("delete");
    ...
    public void TC_13_would_you_like_to_change_this_delivery_email_to_Draft_status_Cancel_basic_information() throws InterruptedException {
        ...
        bi.switch_url_before_run_test("save as draft");
