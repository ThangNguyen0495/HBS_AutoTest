...
//    }
    ...
    public void init_group_2() throws InterruptedException {
        // Init Common function
        cm = new Common();
...
//    @Test(priority = 0, groups = {"Create tenant process"})
...
//    }
    ...
    @Test(priority = 1, groups = {"Member information validation"})
    ...
    @Test(priority = 2, groups = {"Member information validation"})
    public void email_exceed_100_characters() throws InterruptedException {
        // Link to Create tenant - Member information tab
        driver.get("https://test.app.cmrb.jp/tenant");
    ...
    @Test(priority = 3, groups = {"Member information validation"})
    public void password_and_confirm_password_less_than_8_characters() throws InterruptedException {
        // Link to Create tenant - Member information tab
        driver.get("https://test.app.cmrb.jp/tenant");
    ...
    @Test(priority = 4, groups = {"Member information validation"})
    public void password_and_confirm_password_exceed_50_characters() throws InterruptedException {
        // Link to Create tenant - Member information tab
        driver.get("https://test.app.cmrb.jp/tenant");
    ...
    @Test(priority = 5, groups = {"Member information validation"})
...
//    }
//
//    @Test(priority = 6, groups = "Company profile information validation")
...
//    }
//
//    @Test(priority = 7, groups = "Company profile information validation")
...
//    }
//
//    @Test(priority = 8, groups = "Company profile information validation")
...
//    }
//
//    @Test(priority = 9, groups = "Company profile information validation")
...
//    }
//
//    @Test(priority = 10, groups = "Company profile information validation")
