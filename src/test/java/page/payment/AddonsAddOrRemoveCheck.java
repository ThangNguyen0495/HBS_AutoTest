...
public class AddonsAddOrRemoveCheck extends Payment {
    ...
    public AddonsAddOrRemoveCheck(WebDriver driver, String domain, String username_admin_page, String password_admin_page) {
        super(driver, domain, username_admin_page, password_admin_page);
        PageFactory.initElements(driver, this);
    }

    public Boolean checkTemplateInStock(WebElement save_button_disable) {
    ...
    public void deleteSearchTemplate(WebElement template_dropdown, WebElement delete_template_button, WebElement ok_button) {
     ...
     */
    public List<Integer> getNumberOfSearchTemplateListPage(String path) throws InterruptedException {
        // link to list page
        ...
        if (!checkTemplateInStock(save_button_disable)) {
            deleteSearchTemplate(search_template_dropdown, delete_template_button, ok_button);
        }
    ...
    public void linkToAttachmentStep() throws InterruptedException {
        ...
        // wait attachmentStep step loading
        sleep(2000);
    }

    public void linkToDestinationSearch() throws InterruptedException {
        // link to attachmentStep step
        linkToAttachmentStep();
     ...
     */
    public List<Integer> getNumberOfSearchTemplateAtDestinationSearchStep() throws InterruptedException {
        linkToDestinationSearch();
        if (!checkTemplateInStock(destination_search_save_button_disable)) {
            deleteSearchTemplate(destination_search_template_dropdown, destination_search_delete_template_button, destination_search_ok_button);
        }
     ...
     */
    public List<Integer> getNumberOfDeliveriesAtDestinationSearchStep() throws InterruptedException {
        linkToDestinationSearch();
     ...
     */
    public List<Integer> getNumberOfCommentTemplate(String path) throws InterruptedException {
     ...
     */
    public Boolean checkMaximumCapacityAtAttachmentStep() throws InterruptedException {
        linkToAttachmentStep();
        return upload_descriptions.getText().equals("※1通のメールに添付できる容量の上限はヘッダー情報を含め10MBです。");
    }

    public void deleteMailAfterGetInformation() throws InterruptedException {
        // scroll to bottom
        sleep(3000);
    ...
    public void searchContactByCondition() throws InterruptedException {
        // Search
    ...
    public Boolean checkNullSearchResult() {
     ...
     */
    public Boolean checkShorteningTheDeliveryInterval() throws InterruptedException {
